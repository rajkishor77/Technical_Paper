...
> Data Engineers use Python because:
> - Easy to write data pipelines
> - Huge library support (Pandas, NumPy, SQLAlchemy)
> - Works well with databases, APIs and cloud tools
> - Supports automation and scheduling of data jobs
...
> Used in: logging, authentication, timing functions
...
>
> - **Extract** — pull data from source (database, API, CSV, S3)
> - **Transform** — clean, filter, aggregate, format the data
> - **Load** — write transformed data to destination (data warehouse, database)
